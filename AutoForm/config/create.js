...
import { Form, Input, Button, Modal, Icon, Radio, Row, Col, Checkbox } from 'antd';
  ...
  getMenu = item => {
    ...
    return (
      <span
        ...
        name="deleteIcon"
      >
        <Icon type="edit" onClick={this.onEdit.bind(this, item.posIndex)} />
        {type === 'F' ? (
          <Icon type="plus-circle" onClick={this.addWidth.bind(this, item.posIndex)} />
        ) : (
          ''
        )}
        {type === 'F' ? (
          <Icon type="minus-circle" onClick={this.minusWidth.bind(this, item.posIndex)} />
        ) : (
          ''
        )}
        <Icon type="close-circle" onClick={this.onDelete.bind(this, item.posIndex)} />
      </span>
    );
  };
